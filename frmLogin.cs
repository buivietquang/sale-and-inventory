...
namespace skelot
{
    public partial class frmLogin : Form
    {
        ...
        SqlConnection cn;
        SqlDataReader dr;
        /*public string connection = @"Data Source=Will\SQLEXPRESS;Initial Catalog=Database;Integrated Security=True";*/
        public string connection = @"Server=localhost;Database=Database;Trusted_Connection=True;";
