       ...
       // string connection = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\Data.accdb";
        ...
        public void getManufacturer()
        {
            ...
            try
            {
                ...
                // lấy bản ghi từ tblManufacturer
                string sql2 = @"Select * from tblManufacturer";
                cm = new SqlCommand(sql2, cn);// tạo đối tượng
                dr = cm.ExecuteReader();// thực thi và lấy dữ liệu
                while (dr.Read())
                {
        ...
        {
            // gọi hàm khi chọn mục trong cbo
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            this.Dispose(); // ẩn form cũ trước khi mở form mới
            frmAM.Show();
        }
        ...
        public void InsertToReorder()
        {
            ...
            else
            {
                try
                {
                    //chèn dữ liệu vào bảng tblReover
